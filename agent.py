...
async def run_terminal_test():
    ...
    # 1. Initialize the Memory Service (no DB URL needed)
    session_service = InMemorySessionService()
    
    # 2. Initialize the Runner
    # We add app_name which is often a required field in some ADK versions
    runner = Runner(
        agent=root_agent, 
    ...
    try:
        # Using run_debug to see the internal logs
...
if __name__ == "__main__":
    # This ensures it only runs when you call the file directly
